    ...
    stages {
        ...
        stage('Incremental Build') {
            ...
            parallel {
                stage ('Linux') {
                    steps {
                        withMaven(maven: 'maven-latest', globalMavenSettingsConfig: 'default-global-settings', mavenSettingsConfig: 'tony-maven-settings', mavenOpts: '${LINUX_MVN_RANDOM}') {
                ...
                //     steps {
                //         withMaven(maven: 'maven-latest', jdk: 'jdk8-latest', globalMavenSettingsConfig: 'default-global-settings', mavenSettingsConfig: 'tony-maven-settings') {
        ...
        */
        stage('Deploy') {
            ...
            steps{
                withMaven(maven: 'maven-latest', jdk: 'jdk8-latest', globalMavenSettingsConfig: 'default-global-settings', mavenSettingsConfig: 'tony-maven-settings', mavenOpts: '${LINUX_MVN_RANDOM}') {
